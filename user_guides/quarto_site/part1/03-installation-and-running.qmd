...
![Schematic representation of the Atlantis model structure and input files. Submodels coloured in green are obligatory. Files marked with \* are required, others are optional.](media/image7.jpg){#fig-atlantis-structure width=6.7in height=4.5in}
...
![Brief overview of the Atlantis *main()* routine that calls other routines implemented in various submodels.](media/image8.jpeg){#fig-main-routine width=7.0in height=5.4in}
