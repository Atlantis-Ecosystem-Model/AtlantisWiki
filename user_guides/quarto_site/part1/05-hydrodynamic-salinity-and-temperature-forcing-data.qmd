...
![Main steps in converting oceanographic files into Atlantis input files, as done using two CSIRO contributed scripts *Hydro* and *Hydroconstruct*. Figure by Javier Porobic Garate.](media/image27.jpeg){#fig-hydro-conversion width=6.9in height=2.2in}
