...
::: {.callout-note}
Several parameter names in Atlantis contain typos that are baked into the source code. Users must spell these parameters exactly as shown in this manual — matching the code — even when the spelling appears wrong. Known cases: [temp_ampltiude]{style="color: orange;"}, [isLightEffected]{style="color: orange;"}, [isNoiseEffected]{style="color: orange;"}.
:::
