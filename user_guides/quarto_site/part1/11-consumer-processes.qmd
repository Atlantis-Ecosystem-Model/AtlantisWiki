...
![Habitat refuge scalar on prey availability as a function of cell area covered with suitable habitats (see box above for details on calculations of suitable cover area).](media/image34.png){#fig-habitat-refuge width=4.43in height=4.25in}
...
![Prey availability scalar δ~size~ of different sized prey for bilogistic selectivity curve.](media/image36.png){#fig-prey-bilogistic width=4.72in height=3.69in}
...
![Oxygen limitation scalar $\delta_{O_2}$ for different ambient oxygen concentrations, assuming $KO_2 = 50$ mgO~2~ m^-3^ and $KO_{2,lim} = 100$ mgO~2~ m^-3^.](media/image38.png){#fig-oxygen-limitation width=4.34in height=3.10in}
...
![Proportion of available energy allocated to SN, depending on the individual's condition (RN/SN, on x axis), and pR and X_RS parameters.](media/image54.png){#fig-energy-allocation-sn width=4.34in height=3.10in}
...
![Nitrogen flow from consumers to detrital and ammonia pools. Parameters that determine allocation between the pools are shown on the arrows. Optional fluxes are shown in dashed arrows.](media/image57.jpg){#fig-nitrogen-flow width=5.79in height=6.26in}
...
![Three calendar years for each of the four age groups (AG1–AG4) illustrated.](media/image58.jpg){#fig-calendar-years-ag width=2.58in height=2.88in}

![Dampening of strong year classes through time.](media/image59.jpeg){#fig-calendar-years-dampening width=2.71in height=2.71in}
