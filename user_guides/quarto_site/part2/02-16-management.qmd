...
These seven options for setting up MPAs can be used separately or in combination in one of the 13 currently available options of the [YYY_flagmpa]{style="color: orange;"} parameter. Because the [YYY_flagmpa]{style="color: orange;"} parameter is fishery specific, different fisheries can be affected by different spatial management (MPA) routines.
...
## Management through seasonal closures {#sec-managment-seasonal-closures}

Another management leaver can be applied through seasonal closures. This management is independent of the stock adaptive or TAC management set with [YYY_flagmanage]{style="color: orange;"} parameter or spatial management through MPAs. Seasonal closures refer to a complete halt of fishing activity for a set period of time every calendar year. Such seasonal closures are used to protect stocks during spawning seasons or to limit fishing effort for other reasons.
